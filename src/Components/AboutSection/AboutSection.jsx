      ...
      <div className="container mx-auto px-10 lg:px-20 flex flex-col-reverse lg:flex-row items-center gap-8">
        ...
        <div className="lg:w-1/2">
          ...
          <p className=" text-lg leading-relaxed">
            Based in <span className="font-semibold">Bangladesh</span>, we have worked with countless 
            clients to create images that speak volumes. Let us help you turn moments into lasting art.
          </p>
        </div>
